...
Module module_ghostscriptib

    Private Declare Function gsapi_new_instance Lib "C:\Program Files\gs\gs9.16\bin\gsdll32.dll" _
      (ByRef instance As IntPtr, _
      ByVal caller_handle As IntPtr) As Integer

    Private Declare Function gsapi_set_stdio Lib "C:\Program Files\gs\gs9.16\bin\gsdll32.dll" _
    ...
    Private Declare Function gsapi_init_with_args Lib "C:\Program Files\gs\gs9.16\bin\gsdll32.dll" _
      (ByVal instance As IntPtr, _
      ByVal argc As Integer, _
      <MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.LPStr)> _
      ByVal argv() As String) As Integer

    Private Declare Function gsapi_exit Lib "C:\Program Files\gs\gs9.16\bin\gsdll32.dll" _
      (ByVal instance As IntPtr) As Integer

    Private Declare Sub gsapi_delete_instance Lib "C:\Program Files\gs\gs9.16\bin\gsdll32.dll" _
